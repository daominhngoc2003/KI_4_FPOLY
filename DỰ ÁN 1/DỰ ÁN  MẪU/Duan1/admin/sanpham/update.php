        ...
        <div class="row">
            ...
            <form action="./index.php?act=updatesp" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="price" class="form-control" value="<?=$sp['price']?>" id="exampleInputPassword1">
                </div>
                <!-- Giảm giá -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="mota" id="exampleFormControlTextarea1" rows="3"><?=$sp['mota']?></textarea>
                </div>
                <br>
                <!-- Button -->
